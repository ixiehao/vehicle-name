...
English: [car-names-database/README.en.md](car-names-database/README.en.md) · 中文: [car-names-database/README.md](car-names-database/README.md)
...
| 协作 | 欢迎全球网友参与补充与修改:[贡献指南](car-names-database/CONTRIBUTING.md)([English](car-names-database/CONTRIBUTING.en.md)) |
| 责任 | [免责声明](car-names-database/DISCLAIMER.md) · [隐私声明](car-names-database/PRIVACY.md) |
| 安全 | [SECURITY.md](car-names-database/SECURITY.md) · [CODE_OF_CONDUCT.md](car-names-database/CODE_OF_CONDUCT.md) |
| 变更记录 | [CHANGELOG.md](car-names-database/CHANGELOG.md) |
...
本资料库仅用于学习、翻译与检索参考,数据整理自公开资料,不保证完全准确,正式使用请以官方口径复核。详见 [DISCLAIMER.md](car-names-database/DISCLAIMER.md)。
