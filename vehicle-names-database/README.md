...
| **品牌** `brands` | 全球 103 个主流品牌(16 国分组) | 103 条 |
| **车型** `models` | 现售 + 停产车型名录(按品牌拆分文件,含生产年份与状态) | 持续扩充中 |
...
| 版本 | 日期 | 说明 |
|------|------|------|
| 1.3.0 | 2026-08-09 | 大规模扩充:新增 37 品牌(路特斯/布加迪/蓝旗亚/Rivian/Lucid/埃安/零跑/问界/岚图等)与 161 款车型;品牌 103 个、车型 1356 |
| 1.2.0 | 2026-08-09 | 新增斯柯达/GMC/小米 3 品牌;补齐萤火虫、理想i8/i6、smart精灵#5、P7+、林肯Z、Tesla Semi 等 21 款缺失车型;联网核实并关闭 35 项待核实条目(剩 16 项);车型总数 1195 |
| 1.1.0 | 2026-08-09 | 开源化改造:拆分数据文件、构建脚本、多语言文档;车型数据大幅扩充 |
